 ...
 */
public class StatefulIntervalSequenceSource extends RichParallelSourceFunction<Long>
        implements CheckpointedFunction, FlinkJobFactory.SourceCreator<Long> {
    ...
    public DataStream<Long> createSource(String[] arguments, StreamExecutionEnvironment executionEnvironment) {
        return new DataStreamSource<>(executionEnvironment,
                ...
                true,
                "StatefulIntervalSequenceSource");
    }
}
